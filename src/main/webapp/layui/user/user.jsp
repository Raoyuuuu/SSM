        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body" style="margin-bottom: 20px">
                ...
                <script type="text/html" id="barDemo">
                    {{#  if(d.rid === 1){ }}
                    <button class="layui-btn layui-btn-disabled layui-btn-sm ">权限</button>
                    ...
                    {{# } else if(d.rid === 2){ }}
                    <a class="layui-btn  layui-btn-sm " lay-event="userRole">权限</a>
                ...
                <script type="text/html" id="role">
                    {{#  if(d.rid!=null){ }}
                     {{d.memo}}
                    {{# } else{ }}
                    <a class="layui-btn  layui-btn-sm " lay-event="saveRole">分配角色</a>
                    {{#  } }}
...
<div class="layui-row" id="updateForm" style="display:none;margin:40px 30px 0 0">
    <form class="layui-form" id="update_form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" id="password" name="password"  autocomplete="new-password" class="layui-input" placeholder="3-15位">
            </div>
        </div>
    ...
    layui.use(['table','layer','form'], function(){
        ...
        table.render({
            ...
            cols: [[ //表头
                ...
                ,{field: 'memo', title: '角色',align:'center',toolbar:"#role"}
        ...
        table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'del'){
                ...
                layer.open({
                    ...
                    type: 2,
                    area: ['35%','33%'],
                    content: getUrl()+'layui/user/userRole.jsp?uid='+data.uid //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                });
            }
            else if(layEvent==='saveRole'){
                layer.open({
                    title:data.usercode,
                    type: 2,
                    area: ['35%','33%'],
                    content: getUrl()+'layui/user/saveRole.jsp?uid='+data.uid //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                });
            }
        });
